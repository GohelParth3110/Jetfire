...
public class IAPManager : MonoBehaviour, IStoreListener
{
    ...
    public static string[] Products = { "com.parth.JetFire.noads", "com.parth.JetFire.coinpack1" , "com.parth.JetFire.coinpack2"
            , "com.parth.JetFire.coinpack3" };
    ...
    public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args)
    {
        ...
        else if (String.Equals(args.purchasedProduct.definition.id, Products[1], StringComparison.Ordinal))
        {
            ...
            DataManager.instance.AddCoin(250);
            Debug.Log("Add coin Ads manager" + 250);
            Debug.Log(string.Format("ProcessPurchase: PASS. Product: '{0}'", args.purchasedProduct.definition.id));
        }
