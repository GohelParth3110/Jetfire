	...
	public void HandleRewardBasedVideoClosed(object sender, EventArgs args)
	{
		...
		if (shouldBeRewarded)
        {
			if (!hasBeenRewarded)
            {
                ...
                if (UiManager.instance.GetUiGameOverScreen().gameObject.activeSelf)
                {


					DataManager.instance.AddCoin(GameManager.instance.GetCurrentGameCoin());
					UiManager.instance.GetUiGameOverScreen().SetTextEarenedCoin(GameManager.instance.GetCurrentGameCoin()*2);
                ...
                {
					UiManager.instance.GetUiReWive().ProcessOFReWiveAds();
